    ...
    public class ContactRoles
    {
        ...
        public static void CreateContactRoles()
        {
            ...
            for (int i = 1; i <= 10; i++)
            {
                ...
                contactRole.Name = "contactRole" + i;
        ...
        {
            //example
            //List<string> contactRoleIds = new List<string>() { "34778001", "3477002", "3477003", "34771" };
        ...
        /// </summary>
        /// <param name="dealId">dealId ID of the Deals</param>
