                ...
                if(response.IsExpected)
                {
                    ...
                    if(responseHandler is ResponseWrapper)
                    {
                        ...
                        foreach(ShareRecord shareRecord in shareRecords)
                        {
                            ...
                            User sharedBy = shareRecord.SharedBy;

                            //Check if user is not null
                            if(sharedBy != null)
                            {
                                //Get the ID of the shared User
                                Console.WriteLine("ShareRecord SharedBy User-ID: " + sharedBy.Id);

                                //Get the FullName of the shared User
                                Console.WriteLine("ShareRecord SharedBy User-FullName: " + sharedBy.FullName);

                                //Get the Zuid of the shared User
                                Console.WriteLine("ShareRecord SharedBy User-Zuid: " + sharedBy.Zuid);
                            }
                        }
