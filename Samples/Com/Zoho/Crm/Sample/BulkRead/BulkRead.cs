...
namespace Com.Zoho.Crm.Sample.BulkRead
{
	public class BulkRead
    {
		...
		public static void CreateBulkReadJob (string moduleAPIName)
        {
            ...
            query.Module = new API.Modules.Module();

			query.Module.APIName = moduleAPIName;
			...
			group111.Field = new API.Fields.Field();

			group111.Field.APIName = "Company";
			...
			group112.Field = new API.Fields.Field();

			group112.Field.APIName = "Owner";
			...
			group121.Field = new API.Fields.Field();

			group121.Field.APIName = "Paid";
			...
			group122.Field = new API.Fields.Field();

			group122.Field.APIName = "Created_Time";
		...
		private static void PrintCriteria (Criteria criteria)
        {
			...
			if(field != null)
			{
				...
				Console.WriteLine("Bulkread Query Criteria Field Id: " + field.Id);

				//Get the Field APIName of the Criteria
				Console.WriteLine("Bulkread Query Criteria Field APIName: " + field.APIName);
			}
			...
			if (criteria.Value != null)
            {
				...
				Console.WriteLine("Bulk read Query Criteria Value: " + JsonConvert.SerializeObject(criteria.Value));
			}
