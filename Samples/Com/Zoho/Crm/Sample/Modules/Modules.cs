...
namespace Com.Zoho.Crm.Sample.Modules
{
    public class Modules
    {
        ...
        private static void PrintCustomView(API.CustomViews.CustomView customView)
        {
            ...
            API.Users.User createdBy = customView.CreatedBy;
            ...
            //Get the ModifiedBy User instance of each Module
            API.Users.User modifiedBy = customView.ModifiedBy;
        ...
        private static void PrintCriteria (Criteria criteria)
        {
			...
			if(field != null)
			{
				...
				Console.WriteLine("Module CustomView Criteria Field Id: " + field.Id);

				//Get the Field APIName of the Criteria
				Console.WriteLine("Module CustomView Criteria Field APIName: " + field.APIName);
			}

			if (criteria.Value != null)
            {
				//Get the Value of the Criteria
				Console.WriteLine("Module CustomView Criteria Value: " + JsonConvert.SerializeObject(criteria.Value));
			}
			...
			if (criteria.GroupOperator != null)
            {
				...
				Console.WriteLine("Module CustomView Criteria Group Operator: " + criteria.GroupOperator.Value);
			}
		}
