...
namespace Com.Zoho.Crm.Sample.Notes
{
    public class Note
    {
        ...
        private static void PrintAttachment(Attachment attachment)
        {
            ...
            Console.WriteLine("Note Attachment SharingPermission: " + attachment.SharingPermission);
            ...
            Console.WriteLine("Note Attachment Type: " + attachment.AttachmentType);
        ...
        public static void CreateNotes()
        {
            ...
            for(int i = 1; i <= 5; i++)
            {
                ...
                parentRecord.Id = 3477061011679001;
