...
namespace Com.Zoho.Crm.API.Pipeline
{
	...
	{
		List<TransferActionResponse> transferPipeline;
		Dictionary<string, int?> keyModified=new Dictionary<string, int?>();

		public List<TransferActionResponse> TransferPipeline
		{
			...
			/// <param name="transferPipeline">Instance of List<TransferActionResponse></param>
			set
			{
